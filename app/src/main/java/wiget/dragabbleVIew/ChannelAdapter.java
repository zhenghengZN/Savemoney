...
import wiget.dragabbleVIew.helper.OnDragVHListener;
import wiget.dragabbleVIew.helper.OnItemMoveListener;
...
public class ChannelAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> implements OnItemMoveListener {
    ...
    private List<MenuBean.ObjectsBeanBean> mMyChannelItems, mOtherChannelItems;

    // 我的频道点击事件
    private OnMyChannelItemClickListener mChannelItemClickListener;

    public ChannelAdapter(Context context, ItemTouchHelper helper, List<MenuBean.ObjectsBeanBean> mMyChannelItems, List<MenuBean.ObjectsBeanBean> mOtherChannelItems) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(final ViewGroup parent, int viewType) {
        ...
        switch (viewType) {
            ...
            case TYPE_MY:
                view = mInflater.inflate(R.layout.subcatory_item_select, parent, false);
            ...
            case TYPE_OTHER:
                view = mInflater.inflate(R.layout.subcatory_item, parent, false);
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
        if (holder instanceof MyViewHolder) {
            ...
            ViewGroup.LayoutParams lp = myHolder.subcategory_ll.getLayoutParams();
            lp.height = mWidth;
            lp.width = mWidth;
            myHolder.subcategory_ll.setLayoutParams(lp);
            GlideHelper.displayGridByResizeasBitmap(CityGuideApplication.getInstance().getApplicationContext(), mMyChannelItems.get(position - COUNT_PRE_MY_HEADER).getPicUrl(), mWidth / 2, mWidth / 2, myHolder.subcategory_img);
            if (isEditMode) {
            ...
            GlideHelper.displayGridByResizeasBitmap(CityGuideApplication.getInstance().getApplicationContext(), mOtherChannelItems.get(position - mMyChannelItems.size() - COUNT_PRE_OTHER_HEADER).getPicUrl(), mWidth / 2, mWidth / 2,  ((OtherViewHolder) holder).subcategory_img);
    ...
    private void moveMyToOther(MyViewHolder myHolder) {
        ...
        MenuBean.ObjectsBeanBean item = mMyChannelItems.get(startPosition);
    ...
    private int processItemRemoveAdd(OtherViewHolder otherHolder) {
        ...
        MenuBean.ObjectsBeanBean item = mOtherChannelItems.get(startPosition);
    ...
    public void onItemMove(int fromPosition, int toPosition) {
        MenuBean.ObjectsBeanBean item = mMyChannelItems.get(fromPosition - COUNT_PRE_MY_HEADER);
   ...
   public interface OnMyChannelItemClickListener {
    ...
    class MyViewHolder extends RecyclerView.ViewHolder implements OnDragVHListener {
        ...
        public MyViewHolder(View itemView) {
            super(itemView);
            textView = (TextView) itemView.findViewById(R.id.subcategory_name);
//            imgEdit = (ImageView) itemView.findViewById(R.id.img_edit);
            ...
            imgEdit = (ImageView) itemView.findViewById(R.id.iv_remove);
        }
